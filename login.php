...
<div id="main">
    <br>
<div class="logform"> <!--Форма входа с 2мя полями и кнопкой войти. Данные из полей передает в файл auth.php, который предоставит
                                разграничение доступа в зависимости от значени role-->
    <form action="auth.php" method="post">
        ...
        <input class="b1" type="submit" value="Войти">
    </form> <!-- Если надо зарегаться на сайте, переходим к др файлу-->
    <p>Впервые у нас? Быстрая регистрация <a href='reg.php'>Здесь</a>
</div>
